        ...
        try:
            ...
            if condition_ok == True and Migrate_start == False:
                ...
                if fetch == True:
                    ...
                    # youtube_details_df = pd.DataFrame(youtube_details)    
                    #print(Channel_id)
                    if Channel_id in channel_ids:
                        ...
                        # st.dataframe(youtube_details_df)
                    else:
